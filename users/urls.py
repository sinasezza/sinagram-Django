...
urlpatterns = [
    ...
    path('contacts/update/<int:id>/', views.change_contact_info_view, name='contact-update'),
    path('contacts/delete/<int:id>/', views.delete_contact_view, name='contact-delete'),
]
